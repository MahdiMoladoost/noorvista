...
/* Sadra 2.1.85 — clinic-manager role guard compatibility */
(function () {
  'use strict';
  if (window.__NOORVISTA_CLINIC_MANAGER_SINGLE_ROLE_GUARD__) return;
  window.__NOORVISTA_CLINIC_MANAGER_SINGLE_ROLE_GUARD__ = true;
