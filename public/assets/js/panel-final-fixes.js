...
(function () {
  ...
  const MENUS = {
    doctor: [
      ...
      { file: "profile.html", label: "پروفایل من", icon: "icon-user" }
    ],
    secretary: [
      { file: "index.html", label: "داشبورد", icon: "icon-dashboard" },
    ...
    patient: [
      { file: "index.html", label: "داشبورد", icon: "icon-dashboard" },
      { file: "appointments.html#book", label: "رزرو نوبت", icon: "icon-clock", match: "appointments.html" },
      { file: "appointments.html", label: "نوبت‌های من", icon: "icon-calendar" },
      { file: "medical-records.html", label: "پرونده پزشکی", icon: "icon-database" },
      { file: "prescriptions.html", label: "نسخه‌ها", icon: "icon-comments" },
      { file: "payments.html", label: "پرداخت‌ها", icon: "icon-credit-card" },
      { file: "profile.html", label: "پروفایل", icon: "icon-user" }
    ]
  };
  ...
  function standardizeRoleSidebar() {
    ...
    // اگر hash رزرو یا ثبت نوبت است، active را روی آیتم مناسب بگذاریم.
...
// مدیر سیستم همیشه باید دقیقاً ۱۳ آیتم ثابت داشته باشد.
(function () {
  ...
  function ensureAdminSidebar() {
    ...
    // برای صفحه logs.html آیتم گزارشات و لاگ‌ها فعال بماند.
