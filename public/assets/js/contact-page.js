...
(function () {
  ...
  function aiReply(message) {
    ...
    if (text.includes("نوبت") || text.includes("دریافت")) {
      return "برای دریافت نوبت، روی دکمه «دریافت نوبت» بزنید و روز و ساعت مناسب را انتخاب کنید. اگر نمی‌دانید کدام خدمت مناسب شماست، همین‌جا علائم یا سوالتان را بنویسید.";
    }
    if (text.includes("بلفارو") || text.includes("پلک")) {
      return "برای افتادگی پلک، پف پلک یا بلفاروپلاستی، ابتدا معاینه تخصصی لازم است تا مشخص شود مشکل زیبایی، عملکردی یا ترکیبی است. می‌توانید نوبت بررسی پلک دریافت کنید.";
    }
    ...
    if (text.includes("آب مروارید") || text.includes("کاتاراکت")) {
      return "برای آب مروارید، زمان مراجعه معمولاً وقتی است که تاری دید، خیرگی یا کاهش دید شب روی کارهای روزمره اثر بگذارد. دریافت معاینه تخصصی بهترین قدم بعدی است.";
    }
    ...
    return "برای راهنمایی دقیق‌تر، لطفاً بفرمایید مشکل اصلی شما چیست: معاینه چشم، لیزر چشم، بلفاروپلاستی، آب مروارید، قوز قرنیه یا دریافت نوبت؟";
  }
