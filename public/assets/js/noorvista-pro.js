...
(function () {
  ...
  window.NoorVistaArticles = articles;
  ...
  async function handleSubmit(event) {
    ...
    try {
      if (isAppointment) {
        ...
        form.reset();
        setStatus(form, 'رزرو نوبت ثبت شد. وضعیت نوبت از مسیر پیگیری یا مشاوره آنلاین قابل بررسی است.', 'success');
      } else {
  ...
  function setupArticlePage() {
    ...
    document.title = `${article.title} | نورویستا`;
    ...
    mount.innerHTML = `
      <div class="nv-article-content">
        ...
        <div class="nv-band" style="margin-top:28px;">
          ...
          <p>اطلاعات این صفحه آموزشی است و جایگزین تشخیص پزشک نیست. برای بررسی شرایط چشم و انتخاب روش مناسب، رزرو نوبت ثبت کنید.</p>
          <a class="nv-btn nv-btn-primary" href="/contact">رزرو نوبت</a>
        </div>
      </div>`;
  }
