        ...
        if (previousStatus !== nextStatus) {
            await connection.query(
                `INSERT INTO appointment_status_history
                 (appointment_id, from_status, to_status, actor_user_id, request_id, ip_address)
                 VALUES (?, ?, ?, ?, ?, ?)`,
                [appointmentId, previousStatus, nextStatus, req.user.id, req.correlationId || null, req.ip || null]
            );
        }
