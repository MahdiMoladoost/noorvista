...
const DEFAULT_PASSWORD_MODE = process.env.INIT_DB_PASSWORD_MODE || 'phone'; // phone | fixed
const FIXED_PASSWORD = process.env.INIT_DB_DEFAULT_PASSWORD || '123456';

const SEED_PEOPLE = [
  {
    roleLabel: 'Doctor',
    roleKind: 'doctor',
    fullName: 'دکتر محمدصادق حق‌پرست',
    phone: '09930713811',
    username: '09930713811',
    specialty: 'چشم‌پزشکی',
  ...
  },
  {
    ...
    fullName: 'مهدی مولادوست',
    phone: '09106661386',
    username: '09106661386',
    gender: 'male',
  },
  {
    ...
    fullName: 'حسین قنبری',
    phone: '09197974194',
    username: '09197974194',
    gender: 'male',
  },
  {
    roleLabel: 'Receptionist',
    roleKind: 'receptionist',
    fullName: 'مهنا مولادوست',
    phone: '09107611392',
    username: '09107611392',
    gender: 'female',
  },
  {
    roleLabel: 'Patient',
    ...
    fullName: 'مهدی مولادوست',
    phone: '09109805772',
    username: '09109805772',
    gender: 'male',
  },
  {
    roleLabel: 'Patient',
    roleKind: 'patient',
    fullName: 'مهدیه شکاری',
    phone: '09126196078',
    username: '09126196078',
    gender: 'female',
  },
];
...
function passwordForPerson(person) {
  if (DEFAULT_PASSWORD_MODE === 'fixed') return FIXED_PASSWORD;
  return person.phone;
}
...
async function seedDoctorProfiles(conn, userIds) {
  ...
  const doctorId = await insertFlexible(conn, 'doctors', {
    ...
    experience_years: 15,
    bio: 'Ophthalmologist in NOORVISTA project',
    consultation_fee: 0,
...
async function seedPatientProfiles(conn, userIds) {
  ...
  for (const patient of patients) {
    ...
    const patientId = await insertFlexible(conn, 'patients', {
      ...
      is_active: 1,
      active: 1,
      national_code: patient.phone.slice(-10),
      birth_date: null,
  ...
  const centers = [
    {
      ...
      phone: '09930713811',
      description: 'مرکز پیش‌فرض نوبت‌دهی کلینیک چشم پزشکی دکتر محمدصادق حق‌پرست',
    },
    {
      ...
      address: 'تهران',
      phone: '02100000000',
      description: 'بیمارستان تریتا تهران',
    },
  ];
...
async function main() {
  ...
  try {
    ...
    console.log('Note: username and password are the user mobile number.');
    for (const person of SEED_PEOPLE) {
